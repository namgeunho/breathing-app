...
<div style="display:flex;justify-content:space-between;font-size:13px;color:var(--text);"><span>연속 달성 ${s}일${lv.next?' / 목표 '+lv.next+'일':''}</span><span>${lv.desc}</span></div>
${lv.next?`<div class="lpb"><div class="lpf" style="width:${Math.min(100,Math.round((s/lv.next)*100))}%;background:#c8a030;"></div></div>`:''}
${!curUser
