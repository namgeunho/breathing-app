/* ── state.js — 전역 상태 변수, 상수
   load order: 2번째 (firebase.js 이후)
── */
/* ── 앱 상태 ── */
...
let sfxVolume=60,bgmVolume=40; // 0~100
...
/* ── 효과음 목록 ── */
/* ── 효과음/배경음 목록 (Firebase에서 로드, 기본값 내장) ── */
let SFX_LIST=[
...
async function loadSounds(){
  try{
    ...
    if(snap.empty) return; // Firebase에 등록된 사운드 없으면 기본값 유지
